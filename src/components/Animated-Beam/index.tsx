...
export function AnimatedBeamMultipleInputDemo() {
  ...
  return (
    ...
    <div
 className="relative flex h-full w-full  lg:min-w-[32rem] sm:w-[22rem] md:w-[34rem] items-center justify-center overflow-hidden border rounded-lg dark:hover:shadow-2xl dark:hover:shadow-[#62818263] dark:border-[#b4fbff38] bg-background p-10 md:shadow-xl"      ref={containerRef}
    >
